...
1. Presentar como pantalla de bienvenida el archivo bienvenida.txt, que ocupa menos de una pantalla; el usuario 
...
DIRINSTAL="$HOME/proyecto/scripts/b3/12/instalacion"
...
# 6) Copia los archivos y maneja errores.
if cp 12/maravil.py 12/LEAME 12/manual.txt "$DIRINSTAL"; then
    echo "Instalación completada con éxito."
else
    echo "Error al copiar los archivos. Se eliminará el directorio de instalación."
    rm -rf "$DIRINSTAL"
    exit 4
fi  